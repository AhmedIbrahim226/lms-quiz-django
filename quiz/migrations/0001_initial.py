    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('on_date', models.DateTimeField(default=datetime.datetime(2022, 5, 1, 19, 33, 4, 731955))),
                ('quiz', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='quiz.quiz')),
                ('user', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='users.studentaccount')),
            ],
        ),
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('answerd_on', models.DateTimeField(default=datetime.datetime(2022, 5, 1, 19, 33, 4, 731503))),
                ('quiz', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='quiz.quiz')),
            ],
        ),
        migrations.CreateModel(
